...
# ساختار جدید: فقط از پورت های کاربری استفاده می‌کنیم
connections = {}  # peer_id -> socket (برای ارسال پیام)
...
class MessengerGUI(QWidget):
    ...
    def init_login_ui(self):
        ...
        self.port_input.setPlaceholderText("Enter your port (e.g., 8001, 8002, 8003)")
